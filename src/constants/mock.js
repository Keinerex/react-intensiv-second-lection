    ...
    films: [
      {
        ...
        name: "ОНО",
        price: 12,
        actors: ["Джейден Мартелл", "София Лиллис"],
      },
      {
        id: "c3cb8f92-a2ed-4716-92a1-b6ea813e9049",
        name: "ОНО2",
        actors: ["Джессика Честейн", "Джеймс МакЭвой"],
      },
      {
        id: "bd129641-c0eb-432b-84b6-8b81d2930358",
        name: "Лето 84",
        price: 8,
        actors: ["Грэм Верчир", "Джуда Льюис"],
      },
    ],
    reviews: [
      {
    ...
    films: [
      {
        ...
        name: "Чужие",
        price: 9,
        actors: ["Сигурни Уивер", "Майкл Бин"],
      },
      {
        id: "90902233-0095-49ea-9939-1e67ed89ffb9",
        name: "Заклятие",
        price: 10,
        actors: ["Вера Фармига", "Патрик Уилсон"],
      },
    ],
    reviews: [
      {
    ...
    films: [
      {
        ...
        name: "Сайлент Хилл",
        price: 5,
        actors: ["Рада Митчелл", "Джоделль Ферланд"],
      },
      {
      ...
      },
      {
        ...
        price: 4,
        actors: ["Хэзер Лэнгенкэмп", "Роберт Инглунд"],
      },
    ],
    reviews: [
      {
